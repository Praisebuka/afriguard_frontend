...
const Home = () => {
  ...
  const handleGenerateReport = async () => {
    ...
    if (!scanResults) { console.log("No scan results available for report generation"); return; }
  ...
  const generatePDFContent = (reportData: any) => {
    ...
    return `
      ...
      <head>
          ...
          <title>AfriGuard Professional Security Assessment Report</title>
          <style>
              * {
                  margin: 0;
                  padding: 0;
      ...
      <body>
          <div class="container">
              ...
              <div class="footer">
                  ...
                  <p><strong>Report Generated by AfriGuard Security Platform</strong></p>
                  <p>© ${new Date().getFullYear()} AfriGuard - Military-Grade Security Assessment</p>
      ...
      try {
        ...
        const reportHTML = `
          ...
          <body>
              ...
              <div class="footer">
                  <p><strong>AfriGuard Security Platform</strong></p>
        ...
        tempDiv.style.cssText = "position: fixed; top: -9999px; left: -9999px; width: 210mm; background: white;";
        ...
        const timestamp = new Date().toISOString().split("T")[0];
        const cleanTarget = target.replace(/[^a-zA-Z0-9]/g, "_");
        const filename = `AfriGuard_Security_Report_${cleanTarget}_${timestamp}.pdf`;
